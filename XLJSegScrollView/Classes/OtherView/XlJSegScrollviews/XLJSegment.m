...
- (void)buttonONclicked:(UIButton *)button
{
    ...
    UIButton *btn = (UIButton *)[self viewWithTag:Button_tag + self.currentSelectedSaveIndex];
...
- (void)creatLineAddSlider
{
    ...
    self.slider = [[UIView alloc] initWithFrame:CGRectMake(btn.frame.origin.x, self.bounds.size.height - 4, [self.titlemArray[self.currentSelectedSaveIndex] doubleValue], 2)];
